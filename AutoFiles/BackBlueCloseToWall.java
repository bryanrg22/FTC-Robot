 ...
 */
 ...
 @Autonomous(name="BackBlueCloseToWall", group = "Mr. Phil")
 public class BackBlueCloseToWall extends LinearOpMode
 {
     ...
     @Override public void runOpMode()
     {
         ...
         if (opModeIsActive())
         {
             robot.strafe( -31, 0.60, 0.25);
             sleep(500);
             
             robot.drive(-8, 0.6, 0.25);
             robot.moveWrist(-1);
             sleep(1000);
             robot.drive(8, 0.6, 0.25);
             sleep(1000);
             ...
             robot.drive(  89, 0.60, 0.25);
             
             //sleep(800);
             //robot.leftGripper(-1);
             //sleep(500);
             //robot.strafe( 8, 0.60, 0.15);
             //sleep(800);
             //robot.drive(  11, 0.60, 0.25);
             //sleep(900);
             //robot.leftGripper(1);
             //sleep(500);
             //robot.moveWrist(1);
             //sleep(800);
             //robot.leftGripper(-1);
             //robot.strafe( -9, 0.60, 0.15);
             //sleep(500);
             //robot.drive(  38, 0.60, 0.25);
             //sleep(800);
             //robot.moveWrist(-1);
             //robot.arm(5);
             //robot.strafe( -88, 0.60, 0.15);
             //sleep(800);
             //robot.turnTo(-90, 0.3, 0.25);
             //sleep(800);
